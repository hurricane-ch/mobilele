...
class CurrencyServiceTestIT {
  ...
  void test_BGN_TO_USD(Double exchangeRate, Double expectedValue) {
    ...
    Optional<ExchangeRateEntity> exRateUSD_BGN = exchangeRateRepository.findByCurrency("USD");
  ...
  void test_BGN_TO_EUR(
    ...
    Optional<ExchangeRateEntity> exRateUSD_BGN = exchangeRateRepository.findByCurrency("EUR");
